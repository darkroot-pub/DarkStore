...
object FirebaseService {
    ...
    suspend fun fetchReviews(appId: String): List<ReviewEntity> = kotlinx.coroutines.withContext(kotlinx.coroutines.Dispatchers.IO) {
        ...
        // Also fetch from Firestore if needed, but let's just stick to RTDB for simplicity or do both.
        // For reviews, usually one DB is fine. Let's do RTDB primary for reviews.
